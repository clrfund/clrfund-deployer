...
export class MACI extends Contract {
  ...
  functions: {
    ...
    "calcEmptyVoteOptionTreeRoot(uint8)"(
      _levels: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
    ...
    "computeEmptyQuinRoot(uint8,uint256)"(
      _treeLevels: BigNumberish,
      _zeroValue: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
    ...
    "computeEmptyRoot(uint8,uint256)"(
      _treeLevels: BigNumberish,
      _zeroValue: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
    ...
    "computeMerkleRootFromPath(uint8,uint256,uint256,uint256[][])"(
      _depth: BigNumberish,
      _index: BigNumberish,
      _leaf: BigNumberish,
      _pathElements: BigNumberish[][],
    ...
    "genBatchUstPublicSignals(uint256,tuple[])"(
      _newStateRoot: BigNumberish,
      _ecdhPubKeys: { x: BigNumberish; y: BigNumberish }[],
      overrides?: CallOverrides
    ): Promise<[BigNumber[]]>;
    ...
    "genQvtPublicSignals(uint256,uint256,uint256,uint256,uint256)"(
      _intermediateStateRoot: BigNumberish,
      _newResultsCommitment: BigNumberish,
      _newSpentVoiceCreditsCommitment: BigNumberish,
      _newPerVOSpentVoiceCreditsCommitment: BigNumberish,
    ...
    "hashMessage((uint256,uint256[10]))"(
      _message: {
        iv: BigNumberish;
        data: [
          BigNumberish,
    ...
    "verifyPerVOSpentVoiceCredits(uint8,uint256,uint256,uint256[][],uint256)"(
      _depth: BigNumberish,
      _index: BigNumberish,
      _leaf: BigNumberish,
      _pathElements: BigNumberish[][],
    ...
    "verifySpentVoiceCredits(uint256,uint256)"(
      _spent: BigNumberish,
      _salt: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[boolean]>;
    ...
    "verifyTallyResult(uint8,uint256,uint256,uint256[][],uint256)"(
      _depth: BigNumberish,
      _index: BigNumberish,
      _leaf: BigNumberish,
      _pathElements: BigNumberish[][],
