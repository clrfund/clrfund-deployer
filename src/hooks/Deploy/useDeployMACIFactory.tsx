...
import { MACIFactory__factory } from "../../typechain/factories/MACIFactory__factory";
  ...
  const handleDeployMACIFactory = useMemo(() => {
    ...
    try {
      const deployContract = async (
        ...
        const maciLibraries = {
          __$1ca93bdf972a371ade5aef0d3bede02ce8$__: poseidonT3Address,
          __$12b92d1cbc3f374ffe86947c65032e94dd$__: poseidonT6Address,
        };
        const MACIFactoryFactory = new MACIFactory__factory(
          {
            ...maciLibraries,
          },
          signer
