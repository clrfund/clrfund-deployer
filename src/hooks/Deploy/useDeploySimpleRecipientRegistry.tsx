...
import { SimpleRecipientRegistry__factory } from "../../typechain/factories/SimpleRecipientRegistry__factory";
...
export function useDeploySimpleRecipientRegistry() {
  ...
  const handleDeploySimpleRecipientRegistry = useMemo(() => {
    ...
    const SimpleRecipientRegistryFactory = new SimpleRecipientRegistry__factory(signer);
