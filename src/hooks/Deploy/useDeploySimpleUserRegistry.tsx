...
import { SimpleUserRegistry__factory } from "../../typechain/factories/SimpleUserRegistry__factory";
...
export function useDeploySimpleUserRegistry() {
  ...
  const handleDeploySimpleUserRegistry = useMemo(() => {
    ...
    const SimpleUserRegistryFactory = new SimpleUserRegistry__factory(signer);
