...
import { FundingRoundFactory__factory } from "../../typechain/factories/FundingRoundFactory__factory";
...
export function useDeployFundingRoundFactory() {
  ...
  const handleDeployFundingRoundFactory = useMemo(() => {
    ...
    const FundingRoundFactoryFactory = new FundingRoundFactory__factory(signer);
