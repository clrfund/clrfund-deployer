...
import { BrightIdUserRegistry__factory } from "../../typechain/factories/BrightIdUserRegistry__factory";
...
export function useDeployBrightIdUserRegistry(){
  ...
  const handleDeployBrightIdUserRegistry = useMemo(() => {
    ...
    const BrightIdUserRegistryFactory = new BrightIdUserRegistry__factory(signer);
