...
/**
 * @description ### Returns  validator,handler, getReceipt, and error hooks for BrightIdUserRegistry RenounceOwnership transactions
 * - Example Response
 * {
      validator: {
    ...
    try {
      ...
      const sendTransaction = async () => {
        ...
        const { data: estimatedGas, error: gasEstimateError } = await handle(
            BrightIdUserRegistryContract.estimateGas.renounceOwnership()
        );
        ...
        const { data: txObject, error: sendError } = await handle(
          BrightIdUserRegistryContract.renounceOwnership( { gasLimit: estimatedGas })
        );
